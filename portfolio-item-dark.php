...
<!-- Mirrored from www.skilltechwebdesign.com/htmlthemes/particle/portfolio-item-dark.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Sep 2020 04:55:18 GMT -->
<head>
...
<div id="st-nav">
    ...
    <nav id="st-main-nav">
        <ul>
            <li>
                <a class="page-scroll hvr-underline-from-center" href="index_dark.php#page-top">Home</a>
            </li>
            <li>
                <a class="page-scroll hvr-underline-from-center" href="index_dark.php#our-work">Our Work</a>
            </li>
            <li>
                <a class="page-scroll hvr-underline-from-center" href="index_dark.php#about">About Us</a>
            </li>
            <li>
                <a class="page-scroll hvr-underline-from-center" href="index_dark.php#services">Services</a>
            </li>
            <li>
                <a class="page-scroll hvr-underline-from-center" href="index_dark.php#skills">Our Skills</a>
            </li>
            <li>
                <a class="page-scroll hvr-underline-from-center" href="index_dark.php#contact">Contact Us</a>
            </li>
        </ul>
    </nav>
</div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <a href="#" class="btn btn-default pull-right hvr-sweep-to-right primary-2-back" id="project-info">Project Info</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-8 col-md-12">
                    ...
                    <div class="portfolio-useful-links">
                        ...
                        <ul class="list-inline portfolio-icons">
                            ...
                            <li>
                                <a href="#" class="primary-back-hover">
                                    <i class="primary fa fa-facebook" aria-hidden="true"></i>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="primary-back-hover">
                                    <i class="primary fa fa-dribbble" aria-hidden="true"></i>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="primary-back-hover">
                                    <i class="primary fa fa-behance" aria-hidden="true"></i>
                                </a>
                            </li>
                        </ul>
                        <!-- /.list-inline -->
...
<!-- Mirrored from www.skilltechwebdesign.com/phpthemes/particle/portfolio-item-dark.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Sep 2020 04:55:21 GMT -->
</html>